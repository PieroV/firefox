...
var test = function (isContent) {
  ...
  let nextTest = function () {
    ...
    SpecialPowers.pushPrefEnv(
      ...
      function () {
        let screenSize, screenAvail;
        if (AppConstants.platform == "android") {
          screenSize = ["innerWidth", "innerHeight"];
          screenAvail = ["innerWidth", "innerHeight"];
        } else {
          let sizes = [
            [1920, 1080],
            [3840, 2160],
          ...
          screenAvail = [screenSize[0], screenSize[1] - availOffset];
        }
        ...
        let pairs = [
          ...
          ["screen.availWidth", screenAvail[0]],
          ["screen.availHeight", screenAvail[1]],
          ["screen.left", 0],
          ["screen.top", 0],
          ["screen.availLeft", 0],
          ["screen.availTop", 0],
